...
## 本日の構成２（アニメソングなど演奏）
![!image_folder/demo2.svg](https://github.com/penkich/Scifesta/blob/main/image_folder/demo2.svg)
## ステッピングモーターについて
...
「M5STACK-U187」 フランスDREAM社のGM音源チップ「SAM2695」を搭載した、⁠M5Stack用のプログラマブルなMIDI音源ユニット。  
「MIDI野郎」 ワンチップGM音源IC、SAM2695を使ったシンセサイザー。  
